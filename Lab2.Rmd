...
```{bash,eval=F}
zcat /project2/xinhe/alan/Lab2_RNAseq_Processing/unmapped_reads/NA18856_argonne.fastq.gz | head -n 4
```
...
* Percentage of reads unmapped. What is the primary reason for unmapped reads?
